...
const HomePage = () => {
  return (
    <HomeLayout>
        <div className="flex-col mx-9 sm:flex-row gap-10 sm:mx-16 h-[90vh] sm:pt-10 text-white md:flex md:items-center md:justify-center lg:flex lg:items-center lg:justify-center">
