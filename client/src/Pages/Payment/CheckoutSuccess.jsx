    ...
    return (
        <HomeLayout>
            <div className="min-h-[90vh] flex items-center justify-center text-white">
                <div className="w-64 mt-10 sm:mt-0 sm:w-80 h-[26rem] flex flex-col justify-center items-center shadow-[0_0_10px_black] rounded-lg relative">
                    ...
                    <div className="px-3 sm:px-4 flex flex-col items-center justify-center space-y-2">
